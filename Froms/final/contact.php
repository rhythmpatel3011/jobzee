                        ...
                        <div class="col-md-8 offset-md-2">
                           <div class="form_cont">
                               <form action="index.html">
                                  <fieldset>
                                     <div class="field">
                                         Mohil<input type="text" name="email" placeholder="Name" value="Mohil@gmail.com" disabled>
                                     </div>
                                     <div class="field">
                                       Rhythm<input type="text" name="email" placeholder="Name" value="rhythm@gmail.com" disabled>
                                     </div>
                                     <div class="field">
                                        Vandit<input type="text" name="email" placeholder="Name" value="vandit@gmail.com" disabled>
                                     </div>
                                     <div class="field">
