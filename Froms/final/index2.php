...
<html lang="en">
  ...
  <body class="leading-normal tracking-normal text-white gradient" style="font-family: 'Source Sans Pro', sans-serif;">
    ...
    <div class="pt-24">
      <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        ...
        <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
          <p class="uppercase tracking-loose w-full">Are you unemployed?</p>
          <h1 class="my-4 text-5xl font-bold leading-tight">
            Seeking for non techinal jobs? 
          </h1>
          <p class="leading-normal text-2xl mb-8">
          This is the place where you want to be.
          </p>
          <button class="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"
          onclick="window.location.href='\PROVIDER_LOGIN.php'">
            Log in as Job Provider
          </button>
         
          <button class="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"
          onclick="window.location.href='\SEEKER_LOGIN.php'" >
          Log in as Seeker
          </button>
        ...
        <div class="w-full md:w-3/5 py-6 text-center">
          <img class="w-full md:w-4/5 z-50" src="https://www.tailwindtoolbox.com/templates/hero.png" />
        </div>
      </div>
    </div>
    ...
    <section class="container mx-auto text-center py-6 mb-12">
      ...
      <button
      onclick="window.location.href='\PROVIDER_REG.php'"
      class="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
        Register as a Job Provider
      </button>
      <button 
      onclick="window.location.href='\SEEKER_REG.php'"
      class="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
